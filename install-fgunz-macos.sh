...
#
# IMPORTANT: The first launch will take 20-30 minutes at the "Loading Pictures"
# screen. This is normal on macOS — the game is compiling OpenGL shaders.
# Subsequent launches may also be slow. Do NOT kill the process during loading.
# =============================================================================
...
#
# NOTE: The first launch takes 20-30 minutes at "Loading Pictures".
# This is normal on macOS. Do not kill the process during loading.
...
echo ""
echo -e "${YELLOW}IMPORTANT:${NC} The first launch will take 20-30 minutes at"
